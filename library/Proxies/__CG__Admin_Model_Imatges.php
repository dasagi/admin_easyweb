 ...
 */
class Admin_Model_Imatges extends \Admin_Model_Imatges implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setGaleriaId($galeriaId);
    }
    ...
    {
        return array('__isInitialized__', '_id', '_data', '_titol', '_descripcio', '_ordre', '_entrades');
    }
