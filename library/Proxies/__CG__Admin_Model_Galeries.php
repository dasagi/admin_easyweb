 ...
 */
class Admin_Model_Galeries extends \Admin_Model_Galeries implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', '_id', '_data', '_titol', '_descripcio', '_idioma', '_publicar', '_entrades');
    }
