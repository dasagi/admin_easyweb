...
class Admin_Form_Menu extends Zend_Form {
    ...
    public function init() {
        ...
        $this->setAction($this->getView()->baseUrl() . '/admin/menu/guardar/')->setMethod('post')->setName('login')->setAttrib('class', 'form-horitzontal');
        ...
        $menuParent = $this->createElement('hidden', 'menuParent',array('value'=>'0'));
        
        
        //crear i configurar element idioma
       ...
       array('ViewScript', array(
            ...
            'viewScript' => 'forms/formMenu.phtml',
